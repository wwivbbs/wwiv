  ...
  for (int i = 0; (i < nNumUserRecords) && !abort && !hangup; i++) {
    ...
    if (ok) {
      ...
      if (p == (GetSession()->GetCurrentUser()->GetScreenLines() - 6)) {
        ...
        GetSession()->bout.ClearEOL();
        GetSession()->bout.Color(FRAME_COLOR);
        pla("Ï\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xBE",
            &abort);
