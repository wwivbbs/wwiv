...
void list_users(int mode) {
  ...
  for (int i = 0; (i < nNumUserRecords) && !abort && !hangup; i++) {
    ...
    if (p == 0 && found) {
      ...
      bout.bputs("",
          &abort);
      found = false;
    }
    ...
    if (ok) {
      ...
      bout.bputs(szUserListLine, &abort);
      num++;
      if (in_qscan) {
        numscn++;
      }
      ...
      if (p == static_cast<int>(a()->user()->GetScreenLines()) - 6) {
        ...
        bout.clreol();
        bout.Color(FRAME_COLOR);
        bout.bputs("",
            &abort);
