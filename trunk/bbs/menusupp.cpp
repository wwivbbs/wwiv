...
void WWIVVersion()
{
    ...
    GetSession()->bout << "|#9Copyright (C) 1998-2007, WWIV Software Services.\r\n";
...
void EditText()
{
    ...
    if ( !fileName.empty() )
    {
        external_edit( fileName.c_str(), "", GetSession()->GetCurrentUser()->GetDefaultEditor() - 1, 500, ".", fileName.c_str(), MSGED_FLAG_NO_TAGLINE );
    }
}
