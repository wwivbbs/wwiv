...
// This works around compiler warning with Visual Studio 2017 where
// You can't use std::transform cleanly with toupper anymore.
static char toupper_char(char c) {
