...
int ZEXPORT deflateInit2_(z_streamp strm, int  level, int  method,
						  ...
						  const char *version, int stream_size)	/* pcg */
{
    deflate_state *s;
    int wrap = 1;
...
/* ========================================================================= */
int ZEXPORT deflateReset (z_streamp strm)	/* pcg */
{
    deflate_state *s;
 ...
 */
local int read_buf(z_streamp strm, Bytef *buf, unsigned size)	/* pcg */
{
 ...
 */
local uInt longest_match(deflate_state *s,		/* pcg */
