...
/* Finally, to build the asm files using MASM 8 so that VC++ 6.0 can use 
   them, use:

	"C:\Program Files\Microsoft Visual Studio 8\VC\bin\ml" /c inffas32.asm
	"C:\Program Files\Microsoft Visual Studio 8\VC\bin\ml" /c match686.asm

	"C:\Program Files\Microsoft Visual Studio 8\VC\bin\x86_amd64\ml64" /c gvmat64.asm
	"C:\Program Files\Microsoft Visual Studio 8\VC\bin\x86_amd64\ml64" /c inffasx64.asm

   Don't use any of the /Z flags, which either give CVPACK errors or missing-
   symbol errors.  /coff is allowable, but has no effect - pcg */
