...
#define SSL_PFLAG_MAX				0x03FF	/* Maximum possible flag value */
...
typedef CHECK_RETVAL STDC_NONNULL_ARG( ( 1, 2 ) ) \
	int ( *SSL_HANDSHAKEFUNCTION )( INOUT SESSION_INFO *sessionInfoPtr,
...
typedef struct SL {
	...
	SSL_HANDSHAKEFUNCTION beginHandshake, exchangeKeys;
	} SSL_HANDSHAKE_INFO;
