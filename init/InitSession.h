...
//
// InitSession - Holds information and status data about the current user
...
//	const char* GetNetworkName() const		        { return net_networks[net_num].name; }
//	const char* GetNetworkDataDirectory() const	    { return net_networks[net_num].dir; }
