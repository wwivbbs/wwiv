...
bool is_rfc1918_private_address(const std::string& ip) {
  ...
  // 10.0.0.0/8 IP addresses: 10.0.0.0 ù 10.255.255.255
  // 172.16.0.0/12 IP addresses: 172.16.0.0 ù 172.31.255.255
  // 192.168.0.0/16 IP addresses: 192.168.0.0 ù 192.168.255.255
